...
const Features = () => {
  return (
    <div className={styles.features__container_all}>
      <h1>This is a test of features</h1>
      <div className={styles.features__container}>
        <div className={styles.feature__container}>
          <span className={styles.icon_pulse}>
            <svg
          ...
          <h3 className={styles.features__heading}>Personalized Bottles</h3>
        </div>
        <div className={styles.feature__container}>
          <span className={styles.icon_pulse}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon icon-tabler icon-tabler-droplet-heart"
              width={40}
              height={40}
              viewBox="0 0 24 24"
              stroke-width={1}
          ...
          <h3 className={styles.features__heading}>Alkaline Water</h3>
        </div>
        <div className={styles.feature__container}>
          <span className={styles.icon_pulse}>
            <svg
          ...
          <h3 className={styles.features__heading}>Comptetive Pricing</h3>
        </div>
      </div>
    </div>
  );
